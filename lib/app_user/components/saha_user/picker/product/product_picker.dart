...
class ProductPickerScreen extends StatefulWidget {
  ...
  ProductPickerScreen(
      {this.callback, this.listProductInput, this.onlyOne = false, this.textHandle});
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  Get.back(result: productPickerController.listCheckSelectedProduct.toList());
                },
                child: Container(
                  width: 100,
                  height: 40,
                  ...
                  child: Center(
                    child: Text(widget.textHandle == null ? 'Thêm' : 'Sao chép', style: TextStyle(color: Colors.white),),
                  ),
                ),
              )
            ],
