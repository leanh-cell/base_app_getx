...
import 'search_bonus_product_controller.dart';

class SearchBonusProductScreen extends StatefulWidget {
  bool? isSearch;
  bool? chooseOne;
  Function? onChoose;
  List<BonusProductSelected>? listBonusProductSelected;
  ...
  @override
  _SearchBonusProductScreenState createState() =>
      _SearchBonusProductScreenState();
}

class _SearchBonusProductScreenState extends State<SearchBonusProductScreen> {
  late SearchBonusProductController searchBonusProductController;
  ...
  void initState() {
    super.initState();
    searchBonusProductController = SearchBonusProductController(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Text(
                        "Chọn nhiều (${searchBonusProductController.listBonusProductItem.length})",
                        maxLines: 1,
                        style: TextStyle(
                            fontSize: 14, fontWeight: FontWeight.w600),
                      ),
                      Spacer(),
                      Obx(() => searchBonusProductController.isChooseMany.value
                          ? TextButton(
                              onPressed: () {
                                searchBonusProductController
                      ...
                      Obx(() => searchBonusProductController.isChooseMany.value
                          ? TextButton(
                              onPressed: () {
                                searchBonusProductController.addAll();
                              },
                ...
                if (widget.onChoose != null) {
                  widget.onChoose!([
                    BonusProductSelected(
                      ...
                      elementDistributeName: null,
                      subElementDistributeName: null,
                      allowsChooseDistribute: true,
                      allowsAllDistribute: true,
                      product: product,
                    )
                  ], false);
                }
                          ...
                          children: [
                            ...
                            Checkbox(
                                ...
                                onChanged: (v) {
                                  searchBonusProductController
                                      .addOrRemoveSelected(
                                    bonusProductSelected: BonusProductSelected(
