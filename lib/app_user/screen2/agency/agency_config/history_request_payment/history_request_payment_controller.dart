...
class HistoryRequestPaymentAgencyController extends GetxController {
  ...
  HistoryRequestPaymentAgencyController() {
    getHistoryPayment();
  }

  Future<void> getHistoryPayment() async {
    try {
      var data = await RepositoryManager.agencyRepository.getHistoryPaymentAgency(sortBy: "id");
      listInit = data!.data!;
