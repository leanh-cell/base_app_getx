...
class ListRequestPaymentAgencyController extends GetxController {
    ...
    try {
      ...
      if (indexInit.isEmpty) {
        ...
        var data = await RepositoryManager.agencyRepository
            .changeStatusPaymentAgency(status, indexInit.value);
  ...
  Future<void> settlementPayment() async {
    try {
      var data = await RepositoryManager.agencyRepository.settlementPaymentAgency();
