...
class _DistributeSelectState extends State<DistributeSelect> {
  ...
  Future<bool> onPop() async {
    ...
    if (valid) {
      widget.onData!(distributeSelectController.getFinalDistribute(), distributeSelectController.quantityCurrent);
    }
