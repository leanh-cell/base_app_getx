...
class ListRequestPaymentSaleScreen extends StatelessWidget {
  late ListRequestPaymentSaleController listRequestPaymentController;
  SahaDataController sahaDataController = Get.find();
  late List<Widget> itemWidget;
  List<String> choices = [
    "Quyết toán cho toàn bộ CTV",
  ];

  ListRequestPaymentSaleScreen({this.isSettlement}) {
    listRequestPaymentController =
        ListRequestPaymentSaleController(isSettlement: isSettlement);
  }
          ...
          Obx(() => listRequestPaymentController.indexInit.isEmpty
                    ...
                    onSelected: (v) async {
                      if (DateTime.now().day != 1 || DateTime.now().day != 17) {
                        if (listRequestPaymentController
                          ...
                          await listRequestPaymentController
                              .settlementPayment();
                          listRequestPaymentController.getListRequestPaymentAgency();
                        }
                      } else {
              ...
              : TextButton(
                  onPressed: () async {
                    ...
                    await listRequestPaymentController.getListRequestPaymentAgency();
                  },
                  child: Text(
                    "Bỏ chọn",
          ...
          children: [
            Row(
              children: [
                ...
                TextButton(
                    onPressed: () async {
                      await listRequestPaymentController.changeStatusPayment(1);
                      listRequestPaymentController.getListRequestPaymentAgency();
                      listRequestPaymentController.indexInit([]);
                    },
                    child: Text(
                ...
                TextButton(
                    onPressed: () async {
                      await listRequestPaymentController.changeStatusPayment(2);
                      listRequestPaymentController.getListRequestPaymentAgency();
                      listRequestPaymentController.indexInit([]);
                    },
                    child: Text(
