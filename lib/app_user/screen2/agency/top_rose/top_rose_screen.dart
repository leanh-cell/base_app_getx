...
import 'top_rose_controller.dart';

class TopRoseScreen extends StatefulWidget {
  @override
  _TopRoseScreenState createState() => _TopRoseScreenState();
}

class _TopRoseScreenState extends State<TopRoseScreen> {
  TopRoseController topCtvController = TopRoseController();
  ...
  Widget itemCtv(Agency ctv, int index) {
    return Column(
      children: [
        Container(
