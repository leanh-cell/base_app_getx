...
import 'set_price_inventory_update.dart';

class DistributeUpdate extends StatefulWidget {
  const DistributeUpdate({Key? key}) : super(key: key);

  @override
  _DistributeUpdateState createState() => _DistributeUpdateState();
}

class _DistributeUpdateState extends State<DistributeUpdate> {
        ...
        child: Obx(
          () => SingleChildScrollView(
            child: Column(
              ...
              children: [
                if (distributeUpdateController.listDistribute.isNotEmpty)
                  buildDistribute(distributeUpdateController.listDistribute[0]),
                SizedBox(
                  height: 15,
                ),
                distributeUpdateController.listDistribute.isEmpty == true
                    ? Center(
                        child: MaterialButton(
                          onPressed: () {
                            inputDialog().then((value) {
                              if (value != null && value.length > 0) {
                                distributeUpdateController.addDistribute(value);
                              }
                            });
                          },
        ...
        child: Column(
          children: [
            SahaButtonFullParent(
              text: "Chỉnh giá bán",
              onPressed: () {
                Get.to(() => SetPriceInventoryUpdate());
              },
      ...
      children: [
        Row(
          ...
          children: [
            InkWell(
              onTap: () {
                inputDialog(initValue: distributes.name).then((value) {
                  if (value != null && value.length > 0) {
                    distributeUpdateController.editNameDistribute(
                        distributeUpdateController.listDistribute
                            .indexOf(distributes),
                        value);
                  }
                });
            ...
            Row(
              children: [
                if (distributeUpdateController.listDistribute
                        .indexOf(distributes) !=
                    1)
                  Row(
                    children: [
                        ...
                        child: Transform.scale(
                          ...
                          child: new CupertinoSwitch(
                            ...
                            onChanged: (bool value1) {
                              distributeUpdateController.toggleHasImage(
                                  distributeUpdateController.listDistribute
                                      .indexOf(distributes));
                            },
                          ),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: buildListDistributes(
                      ...
                      onRemove: (element) {
                        distributeUpdateController.deleteElmDistribute(
                            name: (element as ElementDistributesRequest).name!);
                      },
                      onAdd: () {
                        inputDialog(isElementDistribute: true).then((value) {
                          if (value != null && value.length != 0) {
                            distributeUpdateController.addElmDistribute(
                                elmName: distributes.name!, elmValue: value);
                          }
                        });
                      },
                    ),
                    ...
                    onTap: () {
                      inputDialog(
                        ...
                        if (value != null && value.length > 0) {
                          ...
                          distributeUpdateController.listDistribute.refresh();
                        }
                      });
                    },
                    child: Padding(
                                ...
                                : distributes.elementDistributes!.isNotEmpty
                                    ? distributes.elementDistributes![0]!
                                        ...
                                        : distributes.elementDistributes![0]!
                                            .subElementDistribute!
                                    : null,
                            onRemove: (SubElementDistributeRequest
                                subElementDistribute) {
                              distributeUpdateController.deleteSubDistribute(
                                  name: subElementDistribute.name ?? "");
                            },
                            onAdd: () {
                              inputDialog(isElementDistribute: true)
                                  .then((value) {
                                if (value != null && value.length != 0) {
                                  distributeUpdateController.addSubDistribute(
                                      subName: distributes
                  ...
                  !isAdd &&
                      ...
                      ? Padding(
                          ...
                          child: DottedBorder(
                              ...
                              child: InkWell(
                                onTap: () {
                                  distributeUpdateController.chooseImage(
