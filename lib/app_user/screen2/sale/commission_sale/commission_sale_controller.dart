...
class CommissionSaleController extends GetxController {
  var listTypeCMS =
  ...
  //   try {
  //     var data = await RepositoryManager.saleRepo.configsCollabBonus(
  //         CollaboratorConfig(
  //             typeRose: 0,
  ...
  //     bonusTypeForSaleT2.value = data.data?.bonusTypeForCtvT2 ?? 0;
