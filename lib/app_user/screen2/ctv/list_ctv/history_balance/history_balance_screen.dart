...
import 'history_balance_controller.dart';

class HistoryBalanceScreen extends StatelessWidget {
  Ctv ctv;

  HistoryBalanceScreen({required this.ctv}) {
    controller = HistoryBalanceController(ctv: ctv);
  }

  late HistoryBalanceController controller;
                  ...
                  child: SahaButtonFullParent(
                    ...
                    onPressed: () {
                      showDialogMoney(onInput: (String reason, double money) {
                        controller.addSubHistoryBalance(
