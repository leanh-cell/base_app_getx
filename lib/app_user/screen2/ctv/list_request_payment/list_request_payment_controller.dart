...
class ListRequestPaymentController extends GetxController {
  ...
  bool? isSettlement;
  ListRequestPaymentController({this.isSettlement}) {
  ...
  Future<void> getListRequestPayment() async {
    try {
      var data = await RepositoryManager.ctvRepository.getListRequestPayment();
      listInit = data!.data!;
