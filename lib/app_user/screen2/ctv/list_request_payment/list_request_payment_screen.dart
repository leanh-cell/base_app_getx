...
class ListRequestPaymentScreen extends StatelessWidget {
  late ListRequestPaymentController listRequestPaymentController;
  ...
  ListRequestPaymentScreen({this.isSettlement}) {
    listRequestPaymentController =
        ListRequestPaymentController(isSettlement: isSettlement);
  }
