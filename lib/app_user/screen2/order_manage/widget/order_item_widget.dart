                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (order.lineItemsAtTime![0].distributesSelected !=
                                null &&
                            order.lineItemsAtTime![0].distributesSelected!
                                .isNotEmpty)
                          Text(
                        ...
                        Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Spacer(),
                                if (order.lineItemsAtTime![0].beforePrice !=
                                    order.lineItemsAtTime![0].itemPrice)
                                  Text(
