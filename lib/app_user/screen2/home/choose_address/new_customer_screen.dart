...
import 'new_customer_controller.dart';
...
class NewCustomerScreen extends StatefulWidget {
  ...
  bool? isShowAll;
  NewCustomerScreen(
      {this.infoCustomer, this.isHomeFrom, this.isShowAll, this.infoSearch});
...
class _NewCustomerScreenState extends State<NewCustomerScreen> {
  ...
  late NewCustomerController newCustomerController;
  ...
  void initState() {
    newCustomerController =
        new NewCustomerController(infoCustomerInput: widget.infoCustomer);
    newCustomerController.isShowAddress.value = widget.isShowAll ?? false;
                ...
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    if (widget.infoCustomer != null) {
                      ...
                      var info = newCustomerController.customerChoose.value;
                      ...
                      if (newCustomerController.customerChoose.value.id !=
                          null) {
                        if (widget.isHomeFrom == true) {
                          var info = newCustomerController.customerChoose.value;
                          homeController.cartCurrent.value.customerId = info.id;
