...
class NewCustomerController extends GetxController {
  ...
  NewCustomerController({this.infoCustomerInput}) {
  ...
  Future<void> addCustomer() async {
    try {
      ...
      if (Get.find<SahaDataController>().badgeUser.value.isSale == true) {
        ...
        var data = await RepositoryManager.customerRepository
            .addCustomer(customerChoose.value);
        customerChoose.value = data!.data!;
        SahaAlert.showSuccess(message: "Thêm thành công");
      }
    } catch (err) {
  ...
  Future<void> updateCustomer() async {
    try {
      ...
      var data = await RepositoryManager.customerRepository
          .updateCustomer(infoCustomerInput!.id!, customerChoose.value);
  ...
  Future<void> deleteCustomer() async {
    try {
      var data = await RepositoryManager.customerRepository
          .deleteCustomer(infoCustomerInput!.id!);
