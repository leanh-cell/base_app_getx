...
class ChooseTimeController extends GetxController {
  ...
  ChooseTimeController(
    ...
    listFromDateWEEK = [
      ...
      getDate(DateTime.now()).subtract(Duration(days: 7)),
    ...
    listFromDateMONTH = [
      ...
      getDate(DateTime.now()).subtract(Duration(days: 30)),
    ...
    listFromDateDAYCP([
      ...
      getDate(timeNow!).subtract(Duration(days: 365)),
    ]);
    ...
    listToDateWEEKCP([
      SahaDateUtils().getEndDayOfLastWeekDATETIME(),
      getDate(timeNow!).subtract(Duration(days: 31)),
    ]);
    ...
    listToDateYEARCP([
      getDate(timeNow!).subtract(Duration(days: 366)),
    ]);
